        ...
        >
          <div className="px-6 py-3 bg-[#070b14] border border-slate-800 rounded-2xl text-center min-w-[160px]">
            ...
            <div className="flex items-center gap-2">
              <div className="text-lg font-bold text-white">$25 - $200 JMD</div>
            </div>
          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 pt-2">
              <div className="text-center">
                <div className="flex items-center gap-2">
                <div className="text-2xl font-bold font-mono text-emerald-400">$25 - $200 JMD</div>
                </div>
            ...
            <div className="text-[11px] text-slate-500 font-mono pt-1">
              Text rates: <span className="text-slate-400">$25-$200 JMD per accepted chat pair, based on usefulness, context, and language value.</span><br />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-[#050810] rounded-2xl border border-slate-800 overflow-hidden">
                <div className="flex items-center justify-between px-4 py-2.5 border-b border-slate-800 bg-slate-900/60">
                  ...
                  <span className="text-[10px] font-mono font-bold text-amber-400 bg-amber-950/40 border border-amber-900/30 px-2 py-0.5 rounded-full">Total $50 JMD</span>
                </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1 flex items-start justify-between gap-2">
                        ...
                        <span className="text-[9px] font-mono font-bold text-amber-500 shrink-0">$25</span>
                      </div>
                    </div>
                  </div>
                  {/* Divider */}
              ...
              <div className="bg-[#050810] rounded-2xl border border-emerald-900/30 overflow-hidden">
                <div className="flex items-center justify-between px-4 py-2.5 border-b border-emerald-900/20 bg-emerald-950/20">
                  ...
                  <div className="flex items-center gap-1.5">
                    <span className="text-[10px] font-mono font-bold text-emerald-400 bg-emerald-950/60 border border-emerald-900/40 px-2 py-0.5 rounded-full">$200 JMD</span>
                ...
                <div className="p-4 space-y-2.5">
                  ...
                  <div className="pt-1 border-t border-emerald-900/20 space-y-0.5">
                    ...
                    <span className="text-[9px] text-emerald-600/70 font-mono block">2x verified multiplier applied · base rate $125 JMD capped at $200 JMD this turn</span>
                  </div>
                </div>
              </div>
            </div>
